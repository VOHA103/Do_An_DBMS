 ...
 * @author thuha
 */
public class DK_Admin extends javax.swing.JFrame {

    /**
     * Creates new form DK_Admin
     */
    public DK_Admin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_matkhau, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_dangkyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dangkyActionPerformed
        if (txt_tennguoidung.getText().equals("") || txt_matkhau.getText().equals("") || txt_nhaplaipass.getText().equals("")) {
        ...
        int i = quanTriDao.themQuanTri(txt_tennguoidung.getText().trim(), hoTRo.md5(txt_matkhau.getText().trim()));
        if (i != -1) {
...
//        checkPass();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DK_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
